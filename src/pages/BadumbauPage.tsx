          ...
          <div className="container px-6 md:px-12">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground">
                Wir verwandeln Ihr Badezimmer in eine moderne Wohlfühloase mit eleganten Designs und hochwertigen Materialien.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
              ...
              <div>
                ...
                >
                  ...
                  <h3 className="text-xl font-medium mb-4">Unsere Badumbau-Leistungen umfassen:</h3>
                  <ul className="space-y-3 mb-8">
                    {["Komplettumbau nach Mass", "Barrierefreie Badlösungen", "Hochwertige Sanitäranlagen", "Stilvolle Badmöbel", "Innovative Beleuchtungskonzepte"].map((feature, index) => (
                      <motion.li 
                        key={index} 
