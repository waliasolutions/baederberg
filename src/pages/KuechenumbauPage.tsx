            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
              ...
              <div>
                ...
                >
                  ...
                  <h3 className="text-xl font-medium mb-4">Unsere Küchenumbau-Leistungen umfassen:</h3>
                  <ul className="space-y-3 mb-8">
                    {["Massgeschneiderte Küchenplanungen", "Modernste Küchengeräte", "Hochwertige Arbeitsflächen", "Funktionale Stauraumlösungen", "Energieeffiziente Lösungen"].map((feature, index) => (
                      <motion.li 
                        key={index} 
