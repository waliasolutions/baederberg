...
export const defaultContent: Record<string, any> = {
  ...
  gallery: {
    ...
    items: [
      ...
      { title: 'Einbauschrank Dachgeschoss', image: '/images/innenausbau-d.jpg', category: 'Innenausbau' },
      { title: 'Einbauschrank mit Beleuchtung', image: '/images/innenausbau-e.jpg', category: 'Innenausbau' }
    ]
  },
  regions: {
