  ...
  return <section id="contact" className="py-24 md:py-32">
      <div className="container px-6 md:px-12">
        ...
        duration: 0.7
          ...
          <motion.h2 className="inline-block px-3 py-1 mb-4 text-sm md:text-base text-primary bg-secondary rounded-full" initial={{
          opacity: 0,
          scale: 0.8
        }} whileInView={{
          opacity: 1,
          ...
          <motion.h3 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-6" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div className="bg-white rounded-2xl p-8 shadow-sm" initial={{
          opacity: 0,
          x: -50
        }} whileInView={{
          opacity: 1,
          ...
          transition: {
            ...
            <motion.h4 className="text-2xl font-semibold mb-6" initial={{
            opacity: 0,
            y: 10
          }} whileInView={{
            opacity: 1,
            ...
            {isSuccess && <motion.div className="mb-6 p-4 bg-green-50 text-green-800 rounded-lg" initial={{
            opacity: 0,
            height: 0
          }} animate={{
            opacity: 1,
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <motion.div custom={0} variants={formFieldVariants} initial="hidden" whileInView="visible" viewport={{
                once: true
              }}>
                ...
                <motion.div custom={1} variants={formFieldVariants} initial="hidden" whileInView="visible" viewport={{
                once: true
              }}>
              ...
              <motion.button type="submit" disabled={isSubmitting} className="w-full px-6 py-3 bg-primary text-white rounded-lg flex items-center justify-center gap-2 hover:shadow-lg transition-medium" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
          ...
          <div>
            <motion.div className="bg-white rounded-2xl p-8 shadow-sm mb-8" initial={{
            opacity: 0,
            x: 50
          }} whileInView={{
            opacity: 1,
            ...
            transition: {
              ...
              <div className="space-y-6">
                ...
                duration: 0.5
                    ...
                    <motion.div className="mt-1 h-8 w-8 flex items-center justify-center rounded-full bg-primary/10 text-primary" whileHover={{
                  scale: 1.1,
